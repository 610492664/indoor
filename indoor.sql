...
-- ----------------------------
INSERT INTO `il_building` VALUES ('{BFF5481F-A3DF-F185-927A-83FF572351DB}', '建筑四', '60', '300', 'fasdf', '福华三路100号', '福田中队负责', input('session.user.org_id'));
INSERT INTO `il_building` VALUES ('{6642EB69-0EC0-25FF-29A7-C2842E5AB4A7}', '建筑二', '100', '32767', 'fdsafd', '北四道1号', '', input('session.user.org_id'));
...
-- Records of il_group
-- ----------------------------
INSERT INTO `il_group` VALUES ('{0AFDC3FA-F61E-C09E-B120-57F755E77408}', '第四组', '', input('session.user.org_id'), '0');
INSERT INTO `il_group` VALUES ('{6C2532B0-84AF-31B8-5ADD-0A3E9883AE9A}', '第三组', '', input('session.user.org_id'), '0');
INSERT INTO `il_group` VALUES ('{7F24EB5F-8BF5-0B50-3B14-17654B7593AD}', '第一组', '', input('session.user.org_id'), '0');
...
-- ----------------------------
INSERT INTO `il_incident` VALUES ('{48460920-1AA0-BF9A-34DB-2358A2E7A4E4}', '事件一', '0', '1', '突发火灾', '1462594528', '1462612528', input('session.user.org_id'));
...
-- ----------------------------
INSERT INTO `il_local_equipment` VALUES ('{EDB3F169-BC5B-DE15-F20E-1A68AF657B8E}', '终端二', '2056', input('session.user.org_id'), '0');
INSERT INTO `il_local_equipment` VALUES ('{81667213-50DA-4AEC-9EC8-B11097123D3B}', '中断而', '0', input('session.user.org_id'), '1');
INSERT INTO `il_local_equipment` VALUES ('{9FA11B9A-3704-F002-44E9-2DE4ABA17064}', '终端4', '894556800', input('session.user.org_id'), '0');
INSERT INTO `il_local_equipment` VALUES ('{CB98BEEB-7D18-58F9-E138-43FFD0B04CF1}', '终端三', '639244800', input('session.user.org_id'), '0');
INSERT INTO `il_local_equipment` VALUES ('{C124CD47-C69C-04AE-9FA2-9612C06E69D0}', '终端5', '1399305600', input('session.user.org_id'), '0');
...
-- ----------------------------
INSERT INTO `il_location_mark` VALUES ('{C7448A9E-A9CD-01D5-87FF-4FFC5DB9ECCC}', '信标一', '1', input('session.user.org_id'), 'fdsaf6565', '1');
INSERT INTO `il_location_mark` VALUES ('{50E15174-63B4-3C66-6F5C-EE3B298233E7}', '信标二', '1', input('session.user.org_id'), '6556+56sdf', '0');
...
-- ----------------------------
INSERT INTO `il_locator` VALUES ('{A73E1147-BC5F-C6AB-55D2-266642AA1C4E}', '套件九', '545345', '1329148800', input('session.user.org_id'), '1');
INSERT INTO `il_locator` VALUES ('{40F07D59-23A7-1CB7-E4F3-512239754508}', '套件四', '556546', '1370275200', input('session.user.org_id'), '1');
INSERT INTO `il_locator` VALUES ('{96C78A19-C82A-6A0A-0B2D-6A86CC031088}', '套件七', '654656', '-28800', input('session.user.org_id'), '1');
INSERT INTO `il_locator` VALUES ('{9548413F-9E38-FEC4-1636-58BEAD37A2EF}', '套件六', '5432545', '545410800', input('session.user.org_id'), '1');
INSERT INTO `il_locator` VALUES ('{A24AAF1B-AD2D-03D7-B454-274B1FA99A38}', '套件八', '534254', '2147443200', input('session.user.org_id'), '1');
INSERT INTO `il_locator` VALUES ('{16CCCA18-3A73-3E5A-BB60-FA8FF6DC876D}', '套件二', '31243', '936806400', input('session.user.org_id'), '1');
INSERT INTO `il_locator` VALUES ('{FA9A37EC-758B-6877-6E12-49F9749322B6}', '套件十一', '543656', '-28800', input('session.user.org_id'), '0');
INSERT INTO `il_locator` VALUES ('{C3A80AB2-655A-F369-C341-D491D1E6E939}', '套件十', '1234324', '1378396800', input('session.user.org_id'), '0');
INSERT INTO `il_locator` VALUES ('{1A306EC7-3826-5578-0E04-D257EB43CF3C}', '套件三', '54325', '-28800', input('session.user.org_id'), '3');
INSERT INTO `il_locator` VALUES ('{0B725BAF-7F7D-1ACA-CF37-A586AA79ADEA}', '套件一', '2132', '1399564800', input('session.user.org_id'), '0');
INSERT INTO `il_locator` VALUES ('{6C2F3990-B14D-5194-FD59-1003C3656DEE}', '套件五', '54214', '1428681600', input('session.user.org_id'), '0');
...
-- ----------------------------
INSERT INTO `il_organization` VALUES ('{C584937A-6D3B-B762-1029-095D68D54663}', '子单位一', '一', '科技园高新北四道233号', input('session.user.org_id'), '0');
INSERT INTO `il_organization` VALUES ('{3591E0DD-5013-8640-0BFF-4E48FA697596}', '子单位一', '三', '科技园高新北四道23号', input('session.user.org_id'), '0');
INSERT INTO `il_organization` VALUES (input('session.user.org_id'), '淘米科技有限公司', '淘米科技', '高新北四道贝特尔大厦', null, '0');
...
-- ----------------------------
INSERT INTO `il_person` VALUES ('{5B5E18E7-22E5-8C2F-3E50-2B0803EF85FE}', '人员三', '0', '65548800', '20170613\\eae2b17ecf8e93a1999bf', '1', '444444444', input('session.user.org_id'), '', '1', '3', '1433779200', '{96C78A19-C82A-6A0A-0B2D-6A86CC031088}', '0');
INSERT INTO `il_person` VALUES ('{25EF63DD-7B3B-3770-16C2-2A6E65BEE290}', '王五', '1', '1396627200', '20170613\\eae2b17ecf8e93a1999bf', '1', '6546545454', input('session.user.org_id'), '', '2', '2', '1258732800', '{A73E1147-BC5F-C6AB-55D2-266642AA1C4E}', '0');
INSERT INTO `il_person` VALUES ('{485A04A4-90BC-C425-E350-F7654B6B6FC9}', '李三', '0', '618591600', '20170613\\eae2b17ecf8e93a1999bf', '1', '456446', input('session.user.org_id'), '', '2', '2', '1260633600', '{40F07D59-23A7-1CB7-E4F3-512239754508}', '0');
INSERT INTO `il_person` VALUES ('{F6863A60-4D79-4934-95AB-648D504E004B}', '人员w', '1', '-460022400', '20170623\\990c0207bff34c60304697247a7263d7.jpg', '0', '65556665', input('session.user.org_id'), '', '2', '2', '1430668800', '{9548413F-9E38-FEC4-1636-58BEAD37A2EF}', '0');
INSERT INTO `il_person` VALUES ('{A893365B-305A-CEDB-7688-9720B5330015}', '人员刘', '0', '-28800', '20170622\\37016c6b2c532214f53637a021c7584e.jpg', '0', '95456554', input('session.user.org_id'), '', '2', '3', '-28800', '{A24AAF1B-AD2D-03D7-B454-274B1FA99A38}', '0');
INSERT INTO `il_person` VALUES ('{B4A661EB-B3F5-C40F-B741-9053CC5D2B28}', '人员发', '0', '-28800', '20170623\\b7b27fab7c77201189a9abd805731472.jpg', '0', '654655', input('session.user.org_id'), '', '2', '2', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{E7381CC9-D5A7-9C3E-4F9E-85BA77127E5C}', '人员李', '0', '-28800', '20170613\\eae2b17ecf8e93a1999bf', '0', '5655656+565', input('session.user.org_id'), '', '2', '2', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{6F5AE69C-A5A9-9ABD-A614-1ACF04285F17}', '李三', '0', '1399305600', '', '0', '545645', input('session.user.org_id'), '', '1', '1', '1439049600', '', '0');
INSERT INTO `il_person` VALUES ('{84BF8A96-4BEA-1515-0973-D725E224F656}', '测试11', '0', '736099200', '', '0', '6534656', input('session.user.org_id'), '', '1', '1', '1367596800', '', '0');
INSERT INTO `il_person` VALUES ('{8406C428-7CCB-FD68-284E-01C7E0FA3D0B}', '张三', '0', '1433433600', '', '0', '878778', input('session.user.org_id'), '', '1', '1', '0', '{16CCCA18-3A73-3E5A-BB60-FA8FF6DC876D}', '0');
INSERT INTO `il_person` VALUES ('{E72D8891-8B90-CA1E-A324-D022D2CB6102}', '王宇', '0', '-28800', '', '0', '965454544', input('session.user.org_id'), '', '1', '1', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{0A9ECA32-F234-A673-4837-B2388C12C317}', '王柳', '0', '1420041600', '', '0', '54546565', input('session.user.org_id'), '', '1', '1', '1430755200', '', '0');
INSERT INTO `il_person` VALUES ('{58E2B509-502D-E77D-3902-A3A6F11ED240}', '王文', '0', '-28800', '', '0', '546+65+65', input('session.user.org_id'), '', '1', '1', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{0F6AB859-DA46-C1A3-489A-A1B2BABDFBED}', '王文', '0', '1777996800', '', '0', '+656566', input('session.user.org_id'), '', '1', '1', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{F1962712-E9E6-4400-3922-4200E91F8739}', '人员发', '0', '-28800', '', '0', '654655', input('session.user.org_id'), '', '2', '2', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{A35BF193-C318-C9B9-6B07-CB08CF2E4A75}', '人员发', '0', '-28800', '', '0', '654655', input('session.user.org_id'), '', '2', '2', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{E6A73A0D-E492-21DB-D71E-2ED1058D7C9D}', '人员发', '0', '-28800', '', '0', '654655', input('session.user.org_id'), '', '2', '2', '-28800', '', '0');
INSERT INTO `il_person` VALUES ('{3FE5F5D6-F9D9-F9F2-18B6-53BCCCACCA1A}', '人员刘', '0', '-28800', '', '0', '95456554', input('session.user.org_id'), '', '2', '3', '-28800', '', '0');
...
-- Records of il_role
-- ----------------------------
INSERT INTO `il_role` VALUES ('{193C91B4-9085-4A32-B62E-26C6A14AFBA7}', '普通用户', '拥有查看权限', '0', input('session.user.org_id'), '0', '{BCC57F86-B8F5-15A5-0244-FB0B22F4B05C}', '1501058199');
INSERT INTO `il_role` VALUES ('{1D2850BD-E43F-BED2-F995-37C23EE8E49A}', '普通管理员', '普通', '0', input('session.user.org_id'), '0', '{BCC57F86-B8F5-15A5-0244-FB0B22F4B05C}', '1500637333');
INSERT INTO `il_role` VALUES ('{C407F15A-F477-8AF4-B830-19FEF9B95F54}', '超级管理员', '拥有所有权限', '0', input('session.user.org_id'), '0', '{BCC57F86-B8F5-15A5-0244-FB0B22F4B05C}', '1501036927');
INSERT INTO `il_role` VALUES ('{F8450F09-9220-8002-287D-6ED9A97F62A1}', '编辑管理员', '拥有编辑权限', '0', input('session.user.org_id'), '1', '{BCC57F86-B8F5-15A5-0244-FB0B22F4B05C}', '1501036959');
...
-- Records of il_user
-- ----------------------------
INSERT INTO `il_user` VALUES ('{31B847C6-8598-388E-9E87-C75C37F8076B}', 'yonghu3', '123456', '123456@qq.com', '13888888888', '第二个用户', '0', '0', '0.0.0.0', input('session.user.org_id'), '0', '', '', '1499341299');
INSERT INTO `il_user` VALUES ('{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin@tomee.cn', '13888888888', '超级管理员', '13', '1501924981', '0.0.0.0', input('session.user.org_id'), '0', '', '', '1501144826');
INSERT INTO `il_user` VALUES ('{BCC57F86-B8F5-15A5-0244-FB0B22F4B05C}', 'yonghu2', 'e10adc3949ba59abbe56e057f20f883e', '123456@qq.com', '13888888888', '第二个用户', '50', '1501226744', '0.0.0.0', input('session.user.org_id'), '0', '{1D2850BD-E43F-BED2-F995-37C23EE8E49A}', '', '1499838728');
...
-- ----------------------------
INSERT INTO `il_user_log` VALUES ('{021611F4-36D7-2ECC-03E4-B201D6549CEA}', 'system', 'userlog', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:31:37');
INSERT INTO `il_user_log` VALUES ('{04BBFD84-38E1-060E-9C98-1B168973AB74}', 'admin', 'incident', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:32');
INSERT INTO `il_user_log` VALUES ('{04FF479C-A592-FD84-3033-87C187AC28EE}', 'admin', 'index', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:09');
INSERT INTO `il_user_log` VALUES ('{14F293BF-3E26-02A1-FA83-E6EDFF45C453}', 'admin', 'index', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:30:07');
INSERT INTO `il_user_log` VALUES ('{1CBE71B0-EC04-4EC2-C3C1-35398AABFAB0}', 'admin', 'building', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:27');
INSERT INTO `il_user_log` VALUES ('{1DA1F503-28BB-E415-36AA-5A7709598CAE}', 'admin', 'localequipment', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:24');
INSERT INTO `il_user_log` VALUES ('{26966638-AEEA-260E-9FA8-C51C694364C8}', 'system', 'userlog', 'del', '失败', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:37:20');
INSERT INTO `il_user_log` VALUES ('{2A361677-AC25-C03D-804A-DD11D0685D47}', 'system', 'user', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:10');
INSERT INTO `il_user_log` VALUES ('{2D094B9A-DEAF-1C95-1B88-842F16E61953}', 'system', 'userlog', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:40:14');
INSERT INTO `il_user_log` VALUES ('{2D2A47E4-1419-83A8-54BA-E8322270D0E5}', 'admin', 'person', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:18');
INSERT INTO `il_user_log` VALUES ('{3DAFBC35-A604-1E55-FB6F-D13976A4CA82}', 'admin', 'locationmark', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:23');
INSERT INTO `il_user_log` VALUES ('{4478437E-7093-BF30-F5A7-110EBDA95E1F}', 'admin', 'locationmark', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:20:12');
INSERT INTO `il_user_log` VALUES ('{4690515B-5040-5AE3-F985-83A775C614BF}', 'admin', 'floor', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:28');
INSERT INTO `il_user_log` VALUES ('{46C8D8DC-9B52-9FAE-9778-A4D2E88609B9}', 'admin', 'locationmark', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:22');
INSERT INTO `il_user_log` VALUES ('{4AC13C1D-DF44-C7A3-DD4D-A17409BB0663}', 'admin', 'organization', 'self', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:14');
INSERT INTO `il_user_log` VALUES ('{4CE74AB6-BB9C-F443-6B13-3C1BAB141C80}', 'admin', 'group', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:17');
INSERT INTO `il_user_log` VALUES ('{52F744EC-74FD-70FF-2EA7-645774C77B9F}', 'system', 'node', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:40');
INSERT INTO `il_user_log` VALUES ('{550A84A7-8961-664E-2F6F-F856D097EE60}', 'system', 'userlog', 'del', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:39:36');
INSERT INTO `il_user_log` VALUES ('{5C483B2F-49A2-1BF8-F977-3CF6D34626C0}', 'system', 'user', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:37');
INSERT INTO `il_user_log` VALUES ('{5C5517C6-A31A-2590-12DB-A3702420A9D6}', 'system', 'node', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:20:21');
INSERT INTO `il_user_log` VALUES ('{5F114F2C-CDD7-938D-5898-115AF642CBE0}', 'admin', 'group', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:20:06');
INSERT INTO `il_user_log` VALUES ('{60F47C04-A0D2-93CB-8358-F2C6B9D523A2}', 'admin', 'organization', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:17');
INSERT INTO `il_user_log` VALUES ('{6BB5732B-69B3-186E-B49D-22DE25969063}', 'admin', 'index', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:31:35');
INSERT INTO `il_user_log` VALUES ('{6E758474-3708-F8A1-5937-59D11A528B41}', 'system', 'userlog', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:29:37');
INSERT INTO `il_user_log` VALUES ('{6F2873CC-9460-E473-0C85-F87D78145E7C}', 'system', 'userlog', 'del', '失败', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:37:24');
INSERT INTO `il_user_log` VALUES ('{71FBE49F-3245-E1AA-FDC6-5F6E6B5176FC}', 'admin', 'organization', 'self', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:19:56');
INSERT INTO `il_user_log` VALUES ('{7B35F28B-F36A-C4AA-C39A-E3BBA7A41A58}', 'system', 'user', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:40:00');
INSERT INTO `il_user_log` VALUES ('{8E04228F-26DD-35A6-91B7-AC52A5746C40}', 'system', 'role', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:08');
INSERT INTO `il_user_log` VALUES ('{8EA30F2D-86F4-4A93-53BA-53705DB01D48}', 'system', 'userlog', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:37:16');
INSERT INTO `il_user_log` VALUES ('{94C90CB9-FF01-6BF9-F19E-28DCBE0931C3}', 'system', 'userlog', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:27:17');
INSERT INTO `il_user_log` VALUES ('{96DB446C-82CA-3D97-EE62-8A99A1347686}', 'system', 'node', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:11');
INSERT INTO `il_user_log` VALUES ('{9BB04D5C-6DBB-BE50-CB27-3A9FF63365F8}', 'admin', 'outfirefacility', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:29');
INSERT INTO `il_user_log` VALUES ('{A0E1D889-86A8-45A7-2AA4-B73345ADC168}', 'system', 'userlog', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:52');
INSERT INTO `il_user_log` VALUES ('{AD60CC66-2791-F00C-754A-FF2444F6D416}', 'admin', 'organization', 'self', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:18');
INSERT INTO `il_user_log` VALUES ('{B8724B67-437D-A2F2-235B-D99237C2D2C1}', 'system', 'userlog', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:31:13');
INSERT INTO `il_user_log` VALUES ('{B9340946-00F0-8ED9-647E-676523E31DC5}', 'admin', 'locator', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:21');
INSERT INTO `il_user_log` VALUES ('{BA9B3DE5-82FA-0A96-4F5A-3FF44F6FBCFB}', 'system', 'user', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:07');
INSERT INTO `il_user_log` VALUES ('{BC9450B5-7BED-3E78-1BB3-7F48AE67660D}', 'admin', 'floor', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:28');
INSERT INTO `il_user_log` VALUES ('{BFC31AC6-EC0B-ABEE-B2BD-08D4F5D74781}', 'system', 'role', 'authshow', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:45');
INSERT INTO `il_user_log` VALUES ('{C9F176F2-D867-B639-6DE8-D4174585E705}', 'admin', 'organization', 'self', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:14');
INSERT INTO `il_user_log` VALUES ('{CAF41C86-A184-E221-0E82-127D49C58574}', 'system', 'role', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:43');
INSERT INTO `il_user_log` VALUES ('{D0250472-8234-1A44-55E9-9EFB015A22F1}', 'system', 'userlog', 'del', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:39:29');
INSERT INTO `il_user_log` VALUES ('{D2307216-DAC6-4506-B5CC-39AE590B6FA9}', 'admin', 'index', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:37:14');
INSERT INTO `il_user_log` VALUES ('{DB9184BE-B943-40FC-B659-7B6879395A5A}', 'system', 'role', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:40:02');
INSERT INTO `il_user_log` VALUES ('{E0AF48CE-46A3-A61C-115C-E570DB5DF6DD}', 'admin', 'index', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:31:11');
INSERT INTO `il_user_log` VALUES ('{E1984755-3CA0-5ABE-B3EB-562DBEE7A226}', 'admin', 'localequipment', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:24');
INSERT INTO `il_user_log` VALUES ('{E37D283F-6F60-19BB-936E-0C58C4B3ECE7}', 'admin', 'locator', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:22:21');
INSERT INTO `il_user_log` VALUES ('{E420E31D-8C22-9464-AC89-E9445259BFDC}', 'admin', 'organization', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:20:01');
INSERT INTO `il_user_log` VALUES ('{E773F5C4-ED2F-7EEC-7CF6-1B33D9963269}', 'system', 'role', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:38');
INSERT INTO `il_user_log` VALUES ('{F9625BBA-87CF-A30A-76CE-C17BB8280390}', 'admin', 'organization', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:43:15');
INSERT INTO `il_user_log` VALUES ('{FB208EAE-B2DB-DDC3-3394-AD03A9D81EB7}', 'system', 'node', 'index', '成功', '{6EAADA7E-AAB5-D9F5-11D8-E915D232A81F}', 'admin', input('session.user.org_id'), '0.0.0.0', '2017-08-05 18:40:04');
