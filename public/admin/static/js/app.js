        ...
        fix: function () {
            ...
            if ($("body").hasClass("fixed")) {
                ...
                if (window_height >= sidebar_height) {
                    ...
                    content_wrapper_minheight = window_height - neg;
                } else {
                    $(".content-wrapper, .right-side").css('min-height', sidebar_height);
                    content_wrapper_minheight = sidebar_height;
                }

                //Fix for the control sidebar height
                var controlSidebar = $($.AdminLTE.options.controlSidebarOptions.selector);
                if (typeof controlSidebar !== "undefined") {
                    if (controlSidebar.height() > content_wrapper_minheight) {
        ...
        $(document).off('click', menu + ' li a')
            .on('click', menu + ' li a', function (e) {
                ...
                //If the menu is not visible
                    ...
                    //Get the parent menu
                    var parent = $this.parents('ul.sidebar-menu');
                    //Close all open menus within the parent
                    var ul = parent.find('ul:visible').not($this.parents('ul')).slideUp(animationSpeed);
                    //Remove the menu-open class from the parent
                    ul.removeClass('menu-open');
                    parent.find('li.active').not($this.parents('li')).removeClass('active');
                    //Get the parent li
                    var parent_li = $this.parent("li");
                    parent_li.addClass('active');
                    ...
                    while (($($li).length>0)) {
                        var a_test = $.trim($li.children('a').text());
                        if ($li == $this.parent('li')) {
                            breadcrumb.prepend('<li class="active">'+ a_test +'</li>');
                        } else {
                            breadcrumb.prepend('<li>'+ a_test +'</li>');
                        }
